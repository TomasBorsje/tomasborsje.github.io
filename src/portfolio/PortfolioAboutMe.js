        ...
        return (
            <div id={"PortfolioAboutMe"}>
                <div id="PortfolioEntryTextBody">
                    ...
                    <div id="PortfolioAboutMeDescription">In 2024, I graduated from VUW with a Bachelors of Engineering (Honours) with first class honours, majoring in Software Engineering. I've also been working as an RPA developer since 2021.</div>
